...
class Woo_Tabs extends WP_Widget {
	...
	function Woo_Tabs() {
		$widget_ops = array( 'description' => __( 'This widget is the Tabs that classicly goes into the sidebar. It contains the Popular posts, Latest Posts, Recent comments and a Tag cloud.', 'woothemes' ) );
