...
?>
        ...
        <?php if ( $title ) echo $before_title . apply_filters( 'widget_title', $title, $instance, $this->id_base ) . $after_title; else { ?>
        <h3 class="tlogo"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" /></h3>
		<?php } ?>
